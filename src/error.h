...
#define ERR_ALIGNMENT_MUST_NOT_BE_LARGER_THAN_NATURAL   ERR_CODE(9)

// runtime error
#define ERR_TRAP_INTERGER_DIVIDE_BY_ZERO                ERR_CODE(10)
#define ERR_TRAP_INTERGET_OVERFLOW                      ERR_CODE(11)
#define ERR_TRAP_INVALID_CONVERSION_TO_INTERGER         ERR_CODE(12)
#define ERR_TRAP_UNDEFINED_ELEMENT                      ERR_CODE(13)
#define ERR_TRAP_UNREACHABLE                            ERR_CODE(14)
