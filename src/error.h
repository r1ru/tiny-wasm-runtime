...
// link error
#define ERR_UNKNOWN_IMPORT                                      ERR_CODE(25)

// runtime error
#define ERR_TRAP_INTERGER_DIVIDE_BY_ZERO                        ERR_CODE(26)
#define ERR_TRAP_INTERGET_OVERFLOW                              ERR_CODE(27)
#define ERR_TRAP_INVALID_CONVERSION_TO_INTERGER                 ERR_CODE(28)
#define ERR_TRAP_UNDEFINED_ELEMENT                              ERR_CODE(29)
#define ERR_TRAP_UNREACHABLE                                    ERR_CODE(30)
#define ERR_TRAP_INDIRECT_CALL_TYPE_MISMATCH                    ERR_CODE(31)
#define ERR_TRAP_UNINITIALIZED_ELEMENT                          ERR_CODE(32)
#define ERR_TRAP_OUT_OF_BOUNDS_MEMORY_ACCESS                    ERR_CODE(33)
#define ERR_TRAP_OUT_OF_BOUNDS_TABLE_ACCESS                     ERR_CODE(34)
#define ERR_TRAP_CALL_STACK_EXHAUSTED                           ERR_CODE(35)
#define ERR_INCOMPATIBLE_IMPORT_TYPE                            ERR_CODE(36)